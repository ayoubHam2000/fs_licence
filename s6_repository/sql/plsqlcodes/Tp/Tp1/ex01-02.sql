...
create or replace view CP as select NC from commande;
insert into CP values(50);

-- Insertion Des Tables .

INSERT INTO CLIENT values(1,'Amali','Samir','12-OCT-1978',123,'Rabat');
INSERT INTO CLIENT values(2,'Daoudi','Kamel','8-OCT-1985',124,'Rabat');
...
INSERT INTO Commande values(1,10,'02-OCT-2014',2);
INSERT INTO Commande values(3,20,'2-OCT-2014',4);
INSERT INTO Commande values(3,10,'2-OCT-2014',6);
INSERT INTO Commande (NC,NP,Qte) values(1,20,3);
INSERT INTO Commande values(1,20,'6-OCT-2014',5);
...
Insert into CLIENT_CMD values(7,'MHIDI','BOUSSELHAM','kenitra',2022,2154,'10-OCT-2015'); 
...
create view TEST as select NC, Nom from CLIENT;
select * from CLIENT;
select * from TEST;
insert into CLIENT(NC, Nom) values(4, 'Ayoub');
insert into TEST values(5, 'other');
